...
// @require https://raw.githubusercontent.com/MatiasRDev/AutoScroll/main/dist/autoscroll.bundle.js
// @homepageURL  https://github.com/MatiasRDev/AutoScroll
// @supportURL   https://github.com/MatiasRDev/AutoScroll/issues
// @updateURL    https://raw.githubusercontent.com/MatiasRDev/AutoScroll/main/autoscroll.user.js
// @downloadURL  https://raw.githubusercontent.com/MatiasRDev/AutoScroll/main/autoscroll.user.js
...
(function () {
  ...
  const DEFAULTS = {
    ...
    panelScalePct: 100,        // 50..250 -> escala global del panel
  ...
  panel.style.setProperty('--tm-scale', String(clamp(panelScalePct,50,250)/100));
  setAccent(accent);
      ...
      <section class="tm-sec ${secAppearanceOpen?'':'collapsed'}" id="secAppearance">
        ...
        <div class="tm-sec-body" id="secAppBody" style="${secAppearanceOpen?'':'display:none'}">
          ...
          <div class="tm-as-inline">
            ...
            <input class="tm-as-num" id="tmScale" type="number" min="50" max="250" step="1" value="${panelScalePct}">
            <small class="tm-as-label">Ajusta el tamaño total del panel</small>
          </div>
          <div class="tm-as-inline">
  ...
  function reflectProfileToUI(){
    ...
    if (panel.querySelector('#tmScale')) panel.querySelector('#tmScale').value = String(panelScalePct);
  }
  ...
  function exportConfig(){
    return {
      globals: {
        ...
        ui: { theme, panelOpacity, a11yEnabled, fontScalePct, borderRadiusPx, compactUI, panelWidthPx, shadowAlpha, accent, panelScalePct },
  ...
  const CONFIG_SETTERS = {
    ...
    panelScalePct: (value)=>{ panelScalePct=value; S('panelScalePct', value); },
